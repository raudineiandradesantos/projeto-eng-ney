...
export default function AnotacaoScreen() {
  ...
  async function saveAnnotation() {
    ...
    try {
      if (editItem) {
        await updateDoc(doc(db, 'annotations', editItem.id), {
          text: form.text.trim(),
        ...
        const ref = doc(collection(db, 'annotations'));
        ...
        await setDoc(ref, { ...ann, projectId: currentProject.id, owner: user.uid });
...
const s = StyleSheet.create({
  ...
  cardActions: { flexDirection: 'row', gap: 16, marginTop: 10, paddingTop: 8, borderTopWidth: 1, borderTopColor: Colors.line },
  ...
  modalCard: { backgroundColor: Colors.bg1, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, paddingBottom: 40, borderTopWidth: 1, borderTopColor: Colors.line },
  helperCard: { backgroundColor: Colors.bg1, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, paddingBottom: 40, borderTopWidth: 1, borderTopColor: Colors.line },
  ...
  textarea: { backgroundColor: Colors.bg2, borderWidth: 1, borderColor: Colors.line, borderRadius: 8, padding: 12, color: Colors.ink, marginBottom: 10, fontSize: 14, height: 140 },
  textHelperBtn: { borderWidth: 1, borderColor: Colors.line, borderRadius: 8, padding: 10, alignItems: 'center', marginBottom: 12 },
  textHelperBtnText: { color: Colors.ink2, fontSize: 12, fontWeight: '600' },
  catLabel: { fontSize: 12, color: Colors.ink2, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 },
