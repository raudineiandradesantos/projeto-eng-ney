...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: Colors.bg1, borderWidth: 1, borderColor: Colors.line, borderRadius: 12, padding: 20 },
  cardTitle: { fontSize: 18, fontWeight: '600', color: Colors.ink, marginBottom: 20 },
  label: { fontSize: 12, fontWeight: '600', color: Colors.ink2, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 0.5 },
  input: { backgroundColor: Colors.bg2, borderWidth: 1, borderColor: Colors.line, borderRadius: 8, padding: 12, color: Colors.ink, marginBottom: 16, fontSize: 14 },
